      ...
      <div className="max-w-2xl mx-auto p-6">
        <div className="rounded-2xl overflow-hidden border border-white/10">
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-700 px-6 py-8 flex items-center gap-5">
            <div className="w-20 h-20 rounded-full border-4 border-white/30 overflow-hidden bg-green-800 items-center justify-center text-2xl font-bold text-white flex-shrink-0">
              {avatarSrc
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm mt-1">Administrator</p>
            </div>
          </div>
